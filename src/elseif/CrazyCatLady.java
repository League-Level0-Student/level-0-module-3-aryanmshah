...
public class CrazyCatLady {
	public static void main(String[] args) {
		...
		String color = JOptionPane.showInputDialog("how many cats do you have");
		// 2. Convert their answer into an int
		int cats = Integer.parseInt(color);
		// 3. If they have 3 or more cats, tell them they are a crazy cat lady
		if (cats >= 3) {
			JOptionPane.showConfirmDialog(null, "You are crazy");
		}
		// 4. If they have less than 3 cats AND more than 0 cats, call the method below
		// to show them a cat video
		if (cats <= 3 && cats > 0) {
			playVideo("https://www.youtube.com/watch?v=WnhnXhzepT8");
		}
